...
// version: v20150727 (custom BNK-25-11-2015)
//
// interface:
...
(function (window, document, undefined) {
    ...
    setFieldValue = function (field, value) {
        ...
        if (isCollection(field)) {
            for (i = 0; i < field.length; i++) {
                // WATCH OUT: put the setFieldValue call before && result to prevent issues with BOOLEAN SHORT-CUT EVALUATION in javascript!!!!
                result = setFieldValue(field[i], value) && result; 
            }
        } else
            if (typeof field === "object") {
                var fieldType = "";
    ...
    //(console)logging, disable when console object not exist (embedded browser)
